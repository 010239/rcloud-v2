    ...
    <div class="gf_list_right left">
    	<div class="gf_list_wrap">
        	...
        	<div class="gf_list_top">
                <h1>云应用运行引擎</h1><br>
                <p>RAE（RCloud  Application Engine）是一款弹性、分布式的应用托管环境，支持Java、Python、Ruby、
    node.js、php多种语言环境。帮助开发者快速开发和部署服务端应用程序，并且简化了系统维护工作。
    搭载了丰富的分布式扩展服务，为应用程序提供强大助力。</p>
                <div id="servicebuy"><a href="${ctx}/page/cloudservicePlatform/cloudServiceBuyForPage/8a8be9a4475dcaef01475dcaef7e0000"><input type="button" value="立即开通"/></a><em>实例<i>2000元</i>/月，不限流量!</em></div>
            </div>
...
<input type="hidden" name="serviceId" id="serviceId" value="8a8be9a4475dcaef01475dcaef7e0000">
<!--content end-->
<div class="gf_footer">
