	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"orgName":{
					"regex":/^[a-zA-Z0-9_\u4e00-\u9fa5]+$/,
					"alertText":" 只能包含数字、英文字母、下划线、汉字"
				},
				
				"myuser":{
					"regex":/^[a-zA-Z]{8,14}$/,
					"alertText":" 请输入8-14位英文字符组成的用户名"
				},
				
				"mypassword":{
					"regex":/^(?=.*[a-zA-Z])(?=.*\d)(?=.*[~!@#$%^&*()_+`\-={}\[\]:";'<>?,.\/]).{8,18}$/,
					"alertText":" 请输入8~18位由数字、字符及特殊符号组成的密码"
				},
				
				"mobile":{
					"regex":/^1[3-8]\d{9}$/,
					"alertText":" 请输入您的真实姓正确的手机号码"
				},
				"chinaId":{
					/**
				...
				"myUser" :{
					"regex":/^[a-zA-Z]{1}[a-zA-Z0-9_]{4,16}[a-zA-Z0-9]$/,
					"alertText":" 无效的用户名"
				}
