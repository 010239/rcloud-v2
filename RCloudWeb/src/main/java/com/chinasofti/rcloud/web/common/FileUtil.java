...
public class FileUtil {
	...
	public static String STORE_PATH = resource.getString("upload.file.path")
			.trim();
	public static String TMP_PATH = "temp";
	...
	/**
	 * 
	 * @Title: getDestFilePath
	 * @Description: 存储目的文件的路径
	 * @author sunlulu
	 * @param @param userId
	 ...
	 * @throws
	 */
	public static String getDestFilePath(String userId, String applicationId) {
	...
	public static void deleteFiles(String userId,String applicationId) throws IOException {
		StringBuffer destsb = new StringBuffer();
		destsb.append(STORE_PATH).append(File.separator).append(userId)
				.append(File.separator).append(applicationId)
	...
	public static void moveFileToStore(String applicationId, String filewarTypes)
			throws Exception {

		// 类型
		int filetynwe = filewarTypes.lastIndexOf(".");
		String baseApp = filewarTypes.substring(filetynwe);

		String root_path = LoginUtil.getSession().getServletContext()
				.getRealPath("");
		String userId = LoginUtil.getUserId();
		StringBuffer srcsb = new StringBuffer(root_path);
		srcsb.append(File.separator).append(TMP_PATH).append(File.separator)
				.append(userId);
		StringBuffer destsb = new StringBuffer();
		destsb.append(STORE_PATH).append(File.separator).append(userId)
				.append(File.separator).append(applicationId)
				// .append(File.separator).append(applicationId).append(".war");
				.append(File.separator).append(applicationId).append(baseApp);
		logger.info("源目录" + srcsb.toString());
		logger.info("目的文件" + destsb.toString());
		moveModifyFile(srcsb.toString(), destsb.toString());
	}
	public static String getFileName(String userId, String applicationId)
			throws IOException {
		String filename="";
		StringBuffer destsb = new StringBuffer();
		destsb.append(STORE_PATH).append(File.separator).append(userId)
				.append(File.separator).append(applicationId);
		File srcFile = new File(destsb.toString());
