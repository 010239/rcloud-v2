...
private static CloseableHttpClient client=HttpClients.createDefault();
	...
	public static Header getAuthorizationHeader(CFClientToken token) throws Exception
	{
		return  new BasicHeader("Authorization", "bearer "+token.getAcessToken().getAccess_token());
	}
